...
{
	ProgramIdv = LoadShaders("../labs/9/09_02v_Shader.vert", "../labs/9/09_02v_Shader.frag");
	glUseProgram(ProgramIdv);
}

void CreateShadersFragment(void)
{
	ProgramIdf = LoadShaders("../labs/9/09_02f_Shader.vert", "../labs/9/09_02f_Shader.frag");
...
void Initialize(void)
{
	...
	// Creare VBO si shadere
	CreateVBO();

	// Creare shader fragment si preluare locatii variabile uniforme pentru shaderul de fragment
	...
	// Creare shader varfuri si preluare locatii variabile uniforme pentru shaderul de varfuri
	CreateShadersVertex();
...
void RenderFunction(void)
{
	...
	// Pozitia observatorului si matricea de vizualizare + proiectie: actualizarecatre shader
	...
	glUniform3f(lightPosLoc, 200.f, -300.f, 400.f);
	glUniform3f(lightColorLoc, 1.0f, 1.0f, 1.0f);

	switch (rendermode)
	{
	// modelul de iluminare implementat in shaderul de fragment
	case Il_Frag: 
		glUseProgram(ProgramIdf);
	...
	// modelul de iluminare implementat in shaderul de varfuri
	case Il_Vert:
		glUseProgram(ProgramIdv);
		l1 = 0; l2 = 36; // normale pentru fete, sunt folosite varfurile 0-35
		break;
