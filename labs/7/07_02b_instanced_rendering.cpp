...
// 
//	Biblioteci
       //	Utilizarea functiilor de sistem Windows (crearea de ferestre, manipularea fisierelor si directoarelor);
...
{
	ProgramId = LoadShaders("../labs/7/07_02b_Shader.vert", "../labs/7/07_02b_Shader.frag");
