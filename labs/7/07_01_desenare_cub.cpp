...
//
// 
//	Biblioteci       //	Utilizarea functiilor de sistem Windows (crearea de ferestre, manipularea fisierelor si directoarelor);
...
{
	ProgramId = LoadShaders("../labs/7/07_01_Shader.vert", "../labs/7/07_01_Shader.frag");
