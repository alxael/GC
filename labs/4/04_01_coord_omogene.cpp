...
// ===========================================
// 
//	Program ce deseneaza 2 patrate;
//	ELEMENTE DE NOUTATE:
//	- coordonate omogene;
//
//
...
void RenderFunction(void)
{
    ...
    //  Desenarea patratului determinat de varfurile rosii;
    glDrawArrays(GL_LINE_LOOP, 0, 4);

    //  Desenarea patratului determinat de varfurile albastre;
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Coordonate omogene");		//	Creeaza fereastra de vizualizare, indicand numele acesteia;
