...
glm::mat4 scaleMatrix, transformationMatrix;
...
{
	ProgramId = LoadShaders("../labs/4/04_04_Shader.vert", "../labs/4/04_04_Shader.frag");
...
void Initialize(void)
{
	...
	//	Incarcarea texturii;
	LoadTexture("../labs/4/text_smiley_face.png");
