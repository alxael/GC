...
glm::mat4
	myMatrix,
	resizeMatrix, matrTransl, matrScale, matrTrans;
...
float
	xMin = -400,
	xMax = 500, yMin = -200, yMax = 400;
float
	deltax = xMax - xMin,
	deltay = yMax - yMin,										  // lungimile laturilor dreptunghiului decupat
...
{
	ProgramId = LoadShaders("../labs/3/03_03_Shader.vert", "../labs/3/03_03_Shader.frag");
